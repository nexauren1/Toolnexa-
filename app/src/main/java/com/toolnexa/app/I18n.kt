...
object I18n {
    ...
    private val extraTranslations =
        mapOf(
            ...
            "IA NEURAL" to mapOf("en" to "NEURAL AI", "es" to "IA NEURONAL", "fr" to "IA NEURONALE", "ar" to "الذكاء الاصطناعي العصبي"),
            "LOCAL RÁPIDO" to mapOf("en" to "FAST LOCAL", "es" to "LOCAL RÁPIDO", "fr" to "LOCAL RAPIDE", "ar" to "محلي سريع"),
            "O modelo é obtido pela internet quando necessário. O áudio permanece no aparelho." to mapOf("en" to "The model is obtained from the internet when needed. The audio remains on the device.", "es" to "El modelo se obtiene de Internet cuando es necesario. El audio permanece en el dispositivo.", "fr" to "Le modèle est obtenu via Internet lorsque nécessaire. L’audio reste sur l’appareil.", "ar" to "يتم الحصول على النموذج من الإنترنت عند الحاجة. يبقى الصوت على الجهاز."),
            ...
            "O resultado foi criado pelo motor neural Basic Pitch, com transcrição polifónica e informação de pitch bend. A análise neural exige acesso à internet para obter o modelo." to mapOf("en" to "The result was created by the Basic Pitch neural engine with polyphonic transcription and pitch-bend data. Neural analysis requires internet access to obtain the model.", "es" to "El resultado fue creado por el motor neuronal Basic Pitch con transcripción polifónica y datos de pitch bend. El análisis neuronal requiere Internet para obtener el modelo.", "fr" to "Le résultat a été créé par le moteur neuronal Basic Pitch avec transcription polyphonique et données de pitch bend. L’analyse neuronale nécessite Internet pour obtenir le modèle.", "ar" to "تم إنشاء النتيجة بواسطة محرك Basic Pitch العصبي مع تفريغ متعدد النغمات وبيانات انحناء النغمة. يتطلب التحليل العصبي الإنترنت للحصول على النموذج."),
