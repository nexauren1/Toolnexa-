...
object I18n {
    ...
    private val extraTranslations =
        mapOf(
            ...
            "Preparar IA Neural" to mapOf("en" to "Prepare Neural AI", "es" to "Preparar IA neuronal", "fr" to "Préparer l’IA neuronale", "ar" to "إعداد الذكاء الاصطناعي العصبي"),
            "Baixe o modelo uma vez para ativar a transcrição polifónica. Depois ele fica guardado no aparelho." to mapOf("en" to "Download the model once to enable polyphonic transcription. It stays stored on your device afterward.", "es" to "Descarga el modelo una vez para activar la transcripción polifónica. Después queda guardado en el dispositivo.", "fr" to "Téléchargez le modèle une fois pour activer la transcription polyphonique. Il reste ensuite stocké sur l’appareil.", "ar" to "قم بتنزيل النموذج مرة واحدة لتفعيل التفريغ متعدد النغمات. ثم يبقى مخزنًا على الجهاز."),
            "Modelo neural de transcrição musical" to mapOf("en" to "Neural music transcription model", "es" to "Modelo neuronal de transcripción musical", "fr" to "Modèle neuronal de transcription musicale", "ar" to "نموذج عصبي لتفريغ الموسيقى"),
            "Tamanho do modelo" to mapOf("en" to "Model size", "es" to "Tamaño del modelo", "fr" to "Taille du modèle", "ar" to "حجم النموذج"),
            "O modelo é baixado uma vez e reutilizado nas próximas conversões." to mapOf("en" to "The model is downloaded once and reused for future conversions.", "es" to "El modelo se descarga una vez y se reutiliza en futuras conversiones.", "fr" to "Le modèle est téléchargé une fois et réutilisé pour les prochaines conversions.", "ar" to "يتم تنزيل النموذج مرة واحدة وإعادة استخدامه في التحويلات التالية."),
            "Pronto para download" to mapOf("en" to "Ready to download", "es" to "Listo para descargar", "fr" to "Prêt à télécharger", "ar" to "جاهز للتنزيل"),
            "Baixar modelo" to mapOf("en" to "Download model", "es" to "Descargar modelo", "fr" to "Télécharger le modèle", "ar" to "تنزيل النموذج"),
            "A preparar o download..." to mapOf("en" to "Preparing download...", "es" to "Preparando la descarga...", "fr" to "Préparation du téléchargement...", "ar" to "جارٍ إعداد التنزيل..."),
            "A baixar modelo..." to mapOf("en" to "Downloading model...", "es" to "Descargando el modelo...", "fr" to "Téléchargement du modèle...", "ar" to "جارٍ تنزيل النموذج..."),
            "Modelo instalado. A preparar a IA..." to mapOf("en" to "Model installed. Preparing AI...", "es" to "Modelo instalado. Preparando la IA...", "fr" to "Modèle installé. Préparation de l’IA...", "ar" to "تم تثبيت النموذج. جارٍ إعداد الذكاء الاصطناعي..."),
            "Modelo de IA instalado com sucesso." to mapOf("en" to "AI model installed successfully.", "es" to "Modelo de IA instalado correctamente.", "fr" to "Modèle d’IA installé avec succès.", "ar" to "تم تثبيت نموذج الذكاء الاصطناعي بنجاح."),
            "Usar modo local sem IA" to mapOf("en" to "Use local mode without AI", "es" to "Usar modo local sin IA", "fr" to "Utiliser le mode local sans IA", "ar" to "استخدام الوضع المحلي بدون ذكاء اصطناعي"),
            "MODELO LOCAL" to mapOf("en" to "LOCAL MODEL", "es" to "MODELO LOCAL", "fr" to "MODÈLE LOCAL", "ar" to "النموذج المحلي"),
            "O modelo fica guardado no armazenamento privado do aplicativo. O áudio continua a ser processado no próprio aparelho." to mapOf("en" to "The model is stored in the app’s private storage. Audio continues to be processed on the device.", "es" to "El modelo se guarda en el almacenamiento privado de la aplicación. El audio sigue procesándose en el dispositivo.", "fr" to "Le modèle est stocké dans le stockage privé de l’application. L’audio continue d’être traité sur l’appareil.", "ar" to "يتم تخزين النموذج في مساحة التخزين الخاصة بالتطبيق. يستمر الصوت في المعالجة على الجهاز."),
            "Audio to MIDI" to mapOf("en" to "Audio to MIDI", "es" to "Audio a MIDI", "fr" to "Audio vers MIDI", "ar" to "تحويل الصوت إلى MIDI"),
            "TOOLNEXA STUDIO" to mapOf("en" to "TOOLNEXA STUDIO", "es" to "TOOLNEXA STUDIO", "fr" to "TOOLNEXA STUDIO", "ar" to "TOOLNEXA STUDIO"),
            "Transforme melodias gravadas em MIDI editável, com controlo de BPM, transposição, quantização e limpeza." to mapOf("en" to "Turn recorded melodies into editable MIDI with BPM, transpose, quantization and cleanup controls.", "es" to "Convierte melodías grabadas en MIDI editable con controles de BPM, transposición, cuantización y limpieza.", "fr" to "Transformez des mélodies enregistrées en MIDI modifiable avec contrôle du BPM, de la transposition, de la quantification et du nettoyage.", "ar" to "حوّل الألحان المسجلة إلى MIDI قابل للتحرير مع التحكم في سرعة الإيقاع والنقل والتكميم والتنظيف."),
            "Comece com o seu áudio" to mapOf("en" to "Start with your audio", "es" to "Empieza con tu audio", "fr" to "Commencez avec votre audio", "ar" to "ابدأ بملفك الصوتي"),
            "Escolha uma gravação de voz, baixo, guitarra, piano ou outra linha musical. O processamento acontece no próprio aparelho." to mapOf("en" to "Choose a vocal, bass, guitar, piano or other musical line recording. Processing happens on the device.", "es" to "Elige una grabación de voz, bajo, guitarra, piano u otra línea musical. El procesamiento ocurre en el dispositivo.", "fr" to "Choisissez un enregistrement vocal, basse, guitare, piano ou autre ligne musicale. Le traitement se fait sur l’appareil.", "ar" to "اختر تسجيلًا لصوت أو جهير أو غيتار أو بيانو أو خط موسيقي آخر. تتم المعالجة على الجهاز."),
            "Ficheiro de áudio" to mapOf("en" to "Audio file", "es" to "Archivo de audio", "fr" to "Fichier audio", "ar" to "ملف صوتي"),
            "O que esta versão faz" to mapOf("en" to "What this version does", "es" to "Qué hace esta versión", "fr" to "Ce que fait cette version", "ar" to "ما يفعله هذا الإصدار"),
            "4 perfis de deteção: Voz, Melodia, Baixo e Amplo" to mapOf("en" to "4 detection profiles: Voice, Melody, Bass and Wide", "es" to "4 perfiles de detección: Voz, Melodía, Bajo y Amplio", "fr" to "4 profils de détection : Voix, Mélodie, Basse et Large", "ar" to "4 ملفات كشف: صوت، لحن، جهير وواسع"),
            "BPM configurável e quantização 1/8, 1/16 ou 1/32" to mapOf("en" to "Configurable BPM and 1/8, 1/16 or 1/32 quantization", "es" to "BPM configurable y cuantización 1/8, 1/16 o 1/32", "fr" to "BPM réglable et quantification 1/8, 1/16 ou 1/32", "ar" to "سرعة BPM قابلة للتعديل وتكميم 1/8 أو 1/16 أو 1/32"),
            "Transposição de -12 a +12 semitons" to mapOf("en" to "Transpose from -12 to +12 semitones", "es" to "Transposición de -12 a +12 semitonos", "fr" to "Transposition de -12 à +12 demi-tons", "ar" to "النقل من -12 إلى +12 نصف نغمة"),
            "Limpeza e união de notas para um MIDI mais editável" to mapOf("en" to "Note cleanup and merging for a more editable MIDI", "es" to "Limpieza y unión de notas para un MIDI más editable", "fr" to "Nettoyage et fusion des notes pour un MIDI plus modifiable", "ar" to "تنظيف ودمج النغمات للحصول على MIDI أسهل في التحرير"),
            "ÁUDIO PRONTO" to mapOf("en" to "AUDIO READY", "es" to "AUDIO LISTO", "fr" to "AUDIO PRÊT", "ar" to "الصوت جاهز"),
            "Audio → MIDI Studio" to mapOf("en" to "Audio → MIDI Studio", "es" to "Audio → MIDI Studio", "fr" to "Audio → MIDI Studio", "ar" to "استوديو الصوت → MIDI"),
            "Escolha como o ToolNexa deve interpretar a gravação. As opções avançadas afetam o MIDI final." to mapOf("en" to "Choose how ToolNexa should interpret the recording. Advanced options affect the final MIDI.", "es" to "Elige cómo debe interpretar ToolNexa la grabación. Las opciones avanzadas afectan al MIDI final.", "fr" to "Choisissez comment ToolNexa doit interpréter l’enregistrement. Les options avancées affectent le MIDI final.", "ar" to "اختر كيفية تفسير ToolNexa للتسجيل. تؤثر الخيارات المتقدمة على MIDI النهائي."),
            "Perfil de deteção" to mapOf("en" to "Detection profile", "es" to "Perfil de detección", "fr" to "Profil de détection", "ar" to "ملف الكشف"),
            "Escolha o intervalo musical mais adequado ao seu áudio." to mapOf("en" to "Choose the musical range that best fits your audio.", "es" to "Elige el rango musical que mejor se adapte a tu audio.", "fr" to "Choisissez la plage musicale adaptée à votre audio.", "ar" to "اختر النطاق الموسيقي الأنسب للصوت."),
            "Voz" to mapOf("en" to "Voice", "es" to "Voz", "fr" to "Voix", "ar" to "صوت"),
            "Melodia" to mapOf("en" to "Melody", "es" to "Melodía", "fr" to "Mélodie", "ar" to "لحن"),
            "Baixo" to mapOf("en" to "Bass", "es" to "Bajo", "fr" to "Basse", "ar" to "جهير"),
            "Amplo" to mapOf("en" to "Wide", "es" to "Amplio", "fr" to "Large", "ar" to "واسع"),
            "Controla quanto áudio fraco é ignorado durante a deteção." to mapOf("en" to "Controls how much quiet audio is ignored during detection.", "es" to "Controla cuánto audio débil se ignora durante la detección.", "fr" to "Contrôle la quantité de son faible ignorée lors de la détection.", "ar" to "يتحكم في مقدار الصوت الضعيف الذي يتم تجاهله أثناء الكشف."),
            "Estúdio avançado" to mapOf("en" to "Advanced studio", "es" to "Estudio avanzado", "fr" to "Studio avancé", "ar" to "الاستوديو المتقدم"),
            "Configure o andamento e a forma como as notas serão organizadas no MIDI." to mapOf("en" to "Configure tempo and how notes are organized in the MIDI.", "es" to "Configura el tempo y cómo se organizan las notas en el MIDI.", "fr" to "Configurez le tempo et l’organisation des notes dans le MIDI.", "ar" to "اضبط السرعة وكيفية تنظيم النغمات داخل MIDI."),
            "BPM" to mapOf("en" to "BPM", "es" to "BPM", "fr" to "BPM", "ar" to "BPM"),
            "Quantização" to mapOf("en" to "Quantization", "es" to "Cuantización", "fr" to "Quantification", "ar" to "التكميم"),
            "Desligada" to mapOf("en" to "Off", "es" to "Desactivada", "fr" to "Désactivée", "ar" to "إيقاف"),
            "Transposição" to mapOf("en" to "Transpose", "es" to "Transposición", "fr" to "Transposition", "ar" to "النقل"),
            "Limpeza inteligente" to mapOf("en" to "Smart cleanup", "es" to "Limpieza inteligente", "fr" to "Nettoyage intelligent", "ar" to "التنظيف الذكي"),
            "Remove notas muito curtas, junta repetições e evita sobreposição desnecessária." to mapOf("en" to "Removes very short notes, merges repetitions and avoids unnecessary overlap.", "es" to "Elimina notas muy cortas, une repeticiones y evita superposiciones innecesarias.", "fr" to "Supprime les notes très courtes, fusionne les répétitions et évite les chevauchements inutiles.", "ar" to "يزيل النغمات القصيرة جدًا ويدمج التكرارات ويتجنب التداخل غير الضروري."),
            "DICA" to mapOf("en" to "TIP", "es" to "CONSEJO", "fr" to "CONSEIL", "ar" to "نصيحة"),
            "Para voz use Voz. Para linhas graves use Baixo. Para um instrumento com notas altas e baixas use Amplo." to mapOf("en" to "Use Voice for vocals. Use Bass for low lines. Use Wide for instruments with high and low notes.", "es" to "Usa Voz para voces. Usa Bajo para líneas graves. Usa Amplio para instrumentos con notas altas y bajas.", "fr" to "Utilisez Voix pour les chants, Basse pour les lignes graves et Large pour les instruments au registre étendu.", "ar" to "استخدم الصوت للغناء والجهير للخطوط المنخفضة وواسع للآلات ذات النطاق الواسع."),
            "CONVERSÃO CONCLUÍDA" to mapOf("en" to "CONVERSION COMPLETE", "es" to "CONVERSIÓN COMPLETADA", "fr" to "CONVERSION TERMINÉE", "ar" to "اكتمل التحويل"),
            "O resultado está pronto para editar, guardar e partilhar." to mapOf("en" to "The result is ready to edit, save and share.", "es" to "El resultado está listo para editar, guardar y compartir.", "fr" to "Le résultat est prêt à être modifié, enregistré et partagé.", "ar" to "النتيجة جاهزة للتحرير والحفظ والمشاركة."),
            "Resumo da análise" to mapOf("en" to "Analysis summary", "es" to "Resumen del análisis", "fr" to "Résumé de l’analyse", "ar" to "ملخص التحليل"),
            "Notas" to mapOf("en" to "Notes", "es" to "Notas", "fr" to "Notes", "ar" to "النغمات"),
            "Duração" to mapOf("en" to "Duration", "es" to "Duración", "fr" to "Durée", "ar" to "المدة"),
            "Extensão" to mapOf("en" to "Range", "es" to "Extensión", "fr" to "Plage", "ar" to "النطاق"),
            "Tonalidade estimada" to mapOf("en" to "Estimated key", "es" to "Tonalidad estimada", "fr" to "Tonalité estimée", "ar" to "المقام المقدر"),
            "Perfil" to mapOf("en" to "Profile", "es" to "Perfil", "fr" to "Profil", "ar" to "الملف"),
            "Prévia MIDI" to mapOf("en" to "MIDI preview", "es" to "Vista previa MIDI", "fr" to "Aperçu MIDI", "ar" to "معاينة MIDI"),
            "A prévia mostra a posição e a altura das notas detetadas." to mapOf("en" to "The preview shows the position and pitch of detected notes.", "es" to "La vista previa muestra la posición y altura de las notas detectadas.", "fr" to "L’aperçu montre la position et la hauteur des notes détectées.", "ar" to "تُظهر المعاينة موضع وارتفاع النغمات المكتشفة."),
            "Exportar MIDI" to mapOf("en" to "Export MIDI", "es" to "Exportar MIDI", "fr" to "Exporter MIDI", "ar" to "تصدير MIDI"),
            "Guardar no histórico" to mapOf("en" to "Save to history", "es" to "Guardar en el historial", "fr" to "Enregistrer dans l’historique", "ar" to "الحفظ في السجل"),
            "MOTOR ATUAL" to mapOf("en" to "CURRENT ENGINE", "es" to "MOTOR ACTUAL", "fr" to "MOTEUR ACTUEL", "ar" to "المحرك الحالي"),
            "A versão atual usa análise espectral local. Os perfis e o pós-processamento melhoram a preparação do MIDI, enquanto uma futura versão poderá adicionar uma rede de transcrição polifónica dedicada." to mapOf("en" to "The current version uses local spectral analysis. Profiles and post-processing improve MIDI preparation, while a future version may add a dedicated polyphonic transcription network.", "es" to "La versión actual usa análisis espectral local. Los perfiles y el posprocesado mejoran la preparación del MIDI, mientras que una versión futura podrá añadir una red dedicada de transcripción polifónica.", "fr" to "La version actuelle utilise une analyse spectrale locale. Les profils et le post-traitement améliorent la préparation MIDI, tandis qu’une future version pourra ajouter un réseau dédié de transcription polyphonique.", "ar" to "يستخدم الإصدار الحالي تحليلًا طيفيًا محليًا. تعمل الملفات والمعالجة اللاحقة على تحسين MIDI، وقد يضيف إصدار مستقبلي شبكة مخصصة للتفريغ متعدد النغمات."),
            "MIDI exportado com sucesso." to mapOf("en" to "MIDI exported successfully.", "es" to "MIDI exportado correctamente.", "fr" to "MIDI exporté avec succès.", "ar" to "تم تصدير MIDI بنجاح."),
            "maior" to mapOf("en" to "major", "es" to "mayor", "fr" to "majeur", "ar" to "ماجور"),
            "menor" to mapOf("en" to "minor", "es" to "menor", "fr" to "mineur", "ar" to "مينور"),
            "Converta uma melodia de áudio em notas MIDI editáveis." to mapOf("en" to "Convert an audio melody into editable MIDI notes.", "es" to "Convierte una melodía de audio en notas MIDI editables.", "fr" to "Convertissez une mélodie audio en notes MIDI modifiables.", "ar" to "حوّل لحنًا صوتيًا إلى نغمات MIDI قابلة للتحرير."),
            "Começar com um áudio" to mapOf("en" to "Start with an audio file", "es" to "Empezar con un audio", "fr" to "Commencer avec un audio", "ar" to "البدء بملف صوتي"),
            "Escolher áudio" to mapOf("en" to "Choose audio", "es" to "Elegir audio", "fr" to "Choisir un audio", "ar" to "اختيار الصوت"),
            "PROCESSAMENTO LOCAL" to mapOf("en" to "LOCAL PROCESSING", "es" to "PROCESAMIENTO LOCAL", "fr" to "TRAITEMENT LOCAL", "ar" to "معالجة محلية"),
            "O áudio é descodificado no próprio aparelho. Não enviamos o ficheiro para um servidor." to mapOf("en" to "The audio is decoded on your device. We do not send the file to a server.", "es" to "El audio se decodifica en el dispositivo. No enviamos el archivo a un servidor.", "fr" to "L’audio est décodé sur l’appareil. Nous n’envoyons pas le fichier à un serveur.", "ar" to "تتم فك ترميز الصوت على جهازك. لا نرسل الملف إلى خادم."),
            "NOTAS IMPORTANTES" to mapOf("en" to "IMPORTANT NOTES", "es" to "NOTAS IMPORTANTES", "fr" to "NOTES IMPORTANTES", "ar" to "ملاحظات مهمة"),
            "A primeira versão é otimizada para uma voz ou um instrumento por vez. Áudio com vários instrumentos pode precisar de edição no MIDI." to mapOf("en" to "The first version is optimized for one voice or one instrument at a time. Audio with multiple instruments may need MIDI editing.", "es" to "La primera versión está optimizada para una voz o un instrumento a la vez. El audio con varios instrumentos puede requerir edición MIDI.", "fr" to "La première version est optimisée pour une voix ou un instrument à la fois. Un audio avec plusieurs instruments peut nécessiter une édition MIDI.", "ar" to "الإصدار الأول مُحسّن لصوت واحد أو آلة واحدة في كل مرة. قد يحتاج الصوت متعدد الآلات إلى تعديل MIDI."),
            ...
            "A converter" to mapOf("en" to "Converting", "es" to "Convirtiendo", "fr" to "Conversion", "ar" to "جارٍ التحويل"),
            "A converter áudio" to mapOf("en" to "Converting audio", "es" to "Convirtiendo audio", "fr" to "Conversion audio", "ar" to "جارٍ تحويل الصوت"),
            "A analisar o áudio e a criar as notas MIDI. Não feche esta tela durante o processo." to mapOf("en" to "Analyzing the audio and creating MIDI notes. Do not close this screen during the process.", "es" to "Analizando el audio y creando notas MIDI. No cierres esta pantalla durante el proceso.", "fr" to "Analyse de l’audio et création des notes MIDI. Ne fermez pas cet écran pendant le traitement.", "ar" to "جارٍ تحليل الصوت وإنشاء نغمات MIDI. لا تغلق هذه الشاشة أثناء العملية."),
            "A analisar áudio..." to mapOf("en" to "Analyzing audio...", "es" to "Analizando audio...", "fr" to "Analyse de l’audio...", "ar" to "جارٍ تحليل الصوت..."),
            "A detetar notas..." to mapOf("en" to "Detecting notes...", "es" to "Detectando notas...", "fr" to "Détection des notes...", "ar" to "جارٍ اكتشاف النغمات..."),
            "PROCESSAMENTO" to mapOf("en" to "PROCESSING", "es" to "PROCESAMIENTO", "fr" to "TRAITEMENT", "ar" to "المعالجة"),
            "MIDI pronto" to mapOf("en" to "MIDI ready", "es" to "MIDI listo", "fr" to "MIDI prêt", "ar" to "ملف MIDI جاهز"),
            "A conversão terminou. O ficheiro está pronto para abrir, partilhar ou guardar." to mapOf("en" to "Conversion complete. The file is ready to open, share or save.", "es" to "Conversión terminada. El archivo está listo para abrir, compartir o guardar.", "fr" to "Conversion terminée. Le fichier est prêt à être ouvert, partagé ou enregistré.", "ar" to "اكتمل التحويل. الملف جاهز للفتح أو المشاركة أو الحفظ."),
            "Abrir / partilhar MIDI" to mapOf("en" to "Open / share MIDI", "es" to "Abrir / compartir MIDI", "fr" to "Ouvrir / partager MIDI", "ar" to "فتح / مشاركة MIDI"),
            "Guardar no armazenamento" to mapOf("en" to "Save to storage", "es" to "Guardar en el almacenamiento", "fr" to "Enregistrer sur le stockage", "ar" to "الحفظ في التخزين"),
            "Converter outro áudio" to mapOf("en" to "Convert another audio", "es" to "Convertir otro audio", "fr" to "Convertir un autre audio", "ar" to "تحويل صوت آخر"),
            "SOBRE O MOTOR" to mapOf("en" to "ABOUT THE ENGINE", "es" to "SOBRE EL MOTOR", "fr" to "À PROPOS DU MOTEUR", "ar" to "حول المحرك"),
            "A primeira versão usa análise de espectro e deteção de frequência para criar notas MIDI. Para maior precisão polifónica, uma futura versão poderá usar um modelo dedicado de transcrição musical." to mapOf("en" to "The first version uses spectrum analysis and frequency detection to create MIDI notes. A future version may use a dedicated music transcription model for greater polyphonic accuracy.", "es" to "La primera versión usa análisis de espectro y detección de frecuencia para crear notas MIDI. Una futura versión podrá usar un modelo dedicado de transcripción musical para mayor precisión polifónica.", "fr" to "La première version utilise l’analyse spectrale et la détection de fréquence pour créer des notes MIDI. Une future version pourra utiliser un modèle dédié de transcription musicale pour plus de précision polyphonique.", "ar" to "يستخدم الإصدار الأول تحليل الطيف واكتشاف التردد لإنشاء نغمات MIDI. قد يستخدم إصدار مستقبلي نموذجًا مخصصًا للتفريغ الموسيقي لتحسين الدقة متعددة النغمات."),
            "Processamento local" to mapOf("en" to "Local processing", "es" to "Procesamiento local", "fr" to "Traitement local", "ar" to "معالجة محلية"),
            "MIDI guardado com sucesso." to mapOf("en" to "MIDI saved successfully.", "es" to "MIDI guardado correctamente.", "fr" to "MIDI enregistré avec succès.", "ar" to "تم حفظ MIDI بنجاح."),
            "Motor de conversão" to mapOf("en" to "Conversion engine", "es" to "Motor de conversión", "fr" to "Moteur de conversion", "ar" to "محرك التحويل"),
            "IA Neural" to mapOf("en" to "Neural AI", "es" to "IA neuronal", "fr" to "IA neuronale", "ar" to "الذكاء الاصطناعي العصبي"),
            "Local rápido" to mapOf("en" to "Fast local", "es" to "Local rápido", "fr" to "Local rapide", "ar" to "محلي سريع"),
            "A IA Neural faz transcrição polifónica. O Local rápido funciona sem descarregar o modelo e serve como fallback." to mapOf("en" to "Neural AI performs polyphonic transcription. Fast local mode works without downloading the model and is used as a fallback.", "es" to "La IA neuronal realiza transcripción polifónica. El modo local rápido funciona sin descargar el modelo y sirve como alternativa.", "fr" to "L’IA neuronale effectue une transcription polyphonique. Le mode local rapide fonctionne sans télécharger le modèle et sert de solution de secours.", "ar" to "ينفذ الذكاء الاصطناعي العصبي تفريغًا متعدد النغمات. يعمل الوضع المحلي السريع دون تنزيل النموذج ويستخدم كخيار احتياطي."),
            "Modelo neural → notas → pitch bends → limpeza → MIDI" to mapOf("en" to "Neural model → notes → pitch bends → cleanup → MIDI", "es" to "Modelo neuronal → notas → pitch bends → limpieza → MIDI", "fr" to "Modèle neuronal → notes → pitch bends → nettoyage → MIDI", "ar" to "النموذج العصبي ← النغمات ← انحناءات النغمات ← التنظيف ← MIDI"),
            "Descodificação → análise → limpeza → exportação" to mapOf("en" to "Decoding → analysis → cleanup → export", "es" to "Decodificación → análisis → limpieza → exportación", "fr" to "Décodage → analyse → nettoyage → exportation", "ar" to "فك الترميز ← التحليل ← التنظيف ← التصدير"),
            "IA NEURAL" to mapOf("en" to "NEURAL AI", "es" to "IA NEURONAL", "fr" to "IA NEURONALE", "ar" to "الذكاء الاصطناعي العصبي"),
            "LOCAL RÁPIDO" to mapOf("en" to "FAST LOCAL", "es" to "LOCAL RÁPIDO", "fr" to "LOCAL RAPIDE", "ar" to "محلي سريع"),
            "O modelo neural está incluído no aplicativo. A inferência acontece no próprio aparelho." to mapOf("en" to "The neural model is included in the app. Inference runs directly on the device.", "es" to "El modelo neuronal está incluido en la aplicación. La inferencia se ejecuta directamente en el dispositivo.", "fr" to "Le modèle neuronal est inclus dans l’application. L’inférence s’exécute directement sur l’appareil.", "ar" to "النموذج العصبي مضمّن في التطبيق. يتم تنفيذ الاستدلال مباشرة على الجهاز."),
            "Este modo não precisa de descarregar um modelo." to mapOf("en" to "This mode does not need to download a model.", "es" to "Este modo no necesita descargar un modelo.", "fr" to "Ce mode ne nécessite pas de télécharger un modèle.", "ar" to "لا يحتاج هذا الوضع إلى تنزيل نموذج."),
            "Transcrição neural" to mapOf("en" to "Neural transcription", "es" to "Transcripción neuronal", "fr" to "Transcription neuronale", "ar" to "التفريغ العصبي"),
            "Pitch bends" to mapOf("en" to "Pitch bends", "es" to "Pitch bends", "fr" to "Pitch bends", "ar" to "انحناءات النغمات"),
            "Motor" to mapOf("en" to "Engine", "es" to "Motor", "fr" to "Moteur", "ar" to "المحرك"),
            "A IA não encontrou notas musicais claras." to mapOf("en" to "The AI did not find clear musical notes.", "es" to "La IA no encontró notas musicales claras.", "fr" to "L’IA n’a pas trouvé de notes musicales claires.", "ar" to "لم يجد الذكاء الاصطناعي نغمات موسيقية واضحة."),
            "A IA Neural não está disponível. A usar o motor local..." to mapOf("en" to "Neural AI is unavailable. Using the local engine...", "es" to "La IA neuronal no está disponible. Usando el motor local...", "fr" to "L’IA neuronale n’est pas disponible. Utilisation du moteur local...", "ar" to "الذكاء الاصطناعي العصبي غير متاح. جارٍ استخدام المحرك المحلي..."),
            "A usar o motor local como fallback." to mapOf("en" to "Using the local engine as fallback.", "es" to "Usando el motor local como alternativa.", "fr" to "Utilisation du moteur local comme solution de secours.", "ar" to "استخدام المحرك المحلي كخيار احتياطي."),
            "O resultado foi criado pelo motor neural Basic Pitch, com transcrição polifónica e informação de pitch bend. O modelo foi baixado e está armazenado localmente, sem enviar o áudio para a API de transcrição." to mapOf("en" to "The result was created by the Basic Pitch neural engine with polyphonic transcription and pitch-bend data. The downloaded model is stored locally and the audio is not sent to a transcription API.", "es" to "El resultado fue creado por el motor neuronal Basic Pitch con transcripción polifónica y datos de pitch bend. El modelo descargado se guarda localmente y el audio no se envía a una API de transcripción.", "fr" to "Le résultat a été créé par le moteur neuronal Basic Pitch avec transcription polyphonique et données de pitch bend. Le modèle téléchargé est stocké localement et l’audio n’est pas envoyé à une API de transcription.", "ar" to "تم إنشاء النتيجة بواسطة محرك Basic Pitch العصبي مع تفريغ متعدد النغمات وبيانات انحناء النغمة. يتم تخزين النموذج الذي تم تنزيله محليًا ولا يتم إرسال الصوت إلى واجهة API للتفريغ."),
            "O resultado foi criado pelo motor local de análise espectral. O modo neural pode ser usado quando o modelo estiver disponível." to mapOf("en" to "The result was created by the local spectral engine. Neural mode can be used when the model is available.", "es" to "El resultado fue creado por el motor local de análisis espectral. El modo neuronal puede usarse cuando el modelo esté disponible.", "fr" to "Le résultat a été créé par le moteur spectral local. Le mode neuronal peut être utilisé lorsque le modèle est disponible.", "ar" to "تم إنشاء النتيجة بواسطة محرك التحليل الطيفي المحلي. يمكن استخدام الوضع العصبي عند توفر النموذج."),
            "A preparar o motor neural..." to mapOf("en" to "Preparing the neural engine...", "es" to "Preparando el motor neuronal...", "fr" to "Préparation du moteur neuronal...", "ar" to "جارٍ إعداد المحرك العصبي..."),
            "Modelo neural carregado. A preparar o áudio..." to mapOf("en" to "Neural model loaded. Preparing audio...", "es" to "Modelo neuronal cargado. Preparando el audio...", "fr" to "Modèle neuronal chargé. Préparation de l’audio...", "ar" to "تم تحميل النموذج العصبي. جارٍ إعداد الصوت..."),
            "Áudio preparado a 22,05 kHz..." to mapOf("en" to "Audio prepared at 22.05 kHz...", "es" to "Audio preparado a 22,05 kHz...", "fr" to "Audio préparé à 22,05 kHz...", "ar" to "تم تجهيز الصوت عند 22.05 كيلوهرتز..."),
            "A transcrever notas com IA..." to mapOf("en" to "Transcribing notes with AI...", "es" to "Transcribiendo notas con IA...", "fr" to "Transcription des notes avec l’IA...", "ar" to "جارٍ تفريغ النغمات بالذكاء الاصطناعي..."),
            "A reconstruir acordes, notas e ataques..." to mapOf("en" to "Reconstructing chords, notes and attacks...", "es" to "Reconstruyendo acordes, notas y ataques...", "fr" to "Reconstruction des accords, notes et attaques...", "ar" to "جارٍ إعادة بناء الأوتار والنغمات والهجمات..."),
            "Transcrição neural concluída." to mapOf("en" to "Neural transcription complete.", "es" to "Transcripción neuronal completada.", "fr" to "Transcription neuronale terminée.", "ar" to "اكتمل التفريغ العصبي."),
            "O motor neural não conseguiu processar o áudio." to mapOf("en" to "The neural engine could not process the audio.", "es" to "El motor neuronal no pudo procesar el audio.", "fr" to "Le moteur neuronal n’a pas pu traiter l’audio.", "ar" to "تعذر على المحرك العصبي معالجة الصوت."),
            "Modelo neural → notas → pitch bends → limpeza → MIDI" to mapOf("en" to "Neural model → notes → pitch bends → cleanup → MIDI", "es" to "Modelo neuronal → notas → pitch bends → limpieza → MIDI", "fr" to "Modèle neuronal → notes → pitch bends → nettoyage → MIDI", "ar" to "النموذج العصبي ← النغمات ← انحناءات النغمات ← التنظيف ← MIDI")
