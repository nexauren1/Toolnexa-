...
async function createSubscription(
  ...
  try {
    ...
    if (
      ...
      const error =
        new Error(
          "O PayPal não devolveu um ID de plano válido."
        );
    ...
    console.error(
      "ToolNexa create subscription failed",
      {
        stage,
        error
      }
    ...
    const message =
      ...
      String(
        ...
        : "Ocorreu um erro interno ao preparar a assinatura.";
    ...
    return json(
      {
        ...
        error:
          error?.code ||
          "paypal_subscription_setup_failed",
        message,
        stage
      },
      status
